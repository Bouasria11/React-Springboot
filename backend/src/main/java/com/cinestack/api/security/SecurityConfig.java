    ...
    SecurityFilterChain securityFilterChain(
        ...
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/movies", "/api/movies/top-rated", "/api/movies/*", "/api/movies/*/reviews", "/api/genres", "/api/genres/**").permitAll()
                        ...
                        .requestMatchers(HttpMethod.PUT, "/api/movies/**", "/api/genres/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/api/movies/**", "/api/genres/**").hasRole("ADMIN")
